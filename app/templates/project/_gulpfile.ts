...
gulp.task('dummy', () => Promise.resolve());
...
gulp.task('build:scripts', gulp.series('rollup', productionMode ? 'uglify' : 'dummy'));
...
gulp.task('build:styles', gulp.series('sass', productionMode ? 'cssnano' : 'dummy'));
